...
**Response**: On average the Gentoo species have larger bills, but the variation between genders seems constant across all penguin
...
**Response**: box plot we can easily see the 5 number summary whereas with a jitterplot the correlation between flipper length and species is more evident.

a strength of the jitterplot is that we can easily see every observation
a strong suit of a box plot is the data is easily comparable between variables
...
**Response**: I prefer the jitterplot overlaid the boxplot, I like being able to see all of the observations
